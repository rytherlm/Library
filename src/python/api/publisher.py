...
class Publisher(Resource):
    def get(self, contributor_id=None):
        if contributor_id is not None:
            sql = "SELECT * FROM Publisher WHERE ContributorID = %s"
    ...
    def post(self):
        ...
        if result:
            ...
            sql_insert_publisher = "INSERT INTO Publisher (ContributorID) VALUES (%s)"
            if exec_commit(sql_insert_publisher, (contributor_id,)):
                return 201
        return 404
    ...
    def delete(self):
        ...
        if contributor_id:
            sql_delete_publisher = "DELETE FROM Publisher WHERE ContributorID = %s"
            exec_commit(sql_delete_publisher, (contributor_id,))
